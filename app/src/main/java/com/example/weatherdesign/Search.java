    ...
    public static class getWeather extends AsyncTask<String , Void , String>  {
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                ...
                String hsunrise = des[1].split(":")[0];
                Long hlsunrise = (Long.parseLong(hsunrise) + 7) % 24;
                String msunrise = des[1].split(":")[1];

                String hsunset = des[2].split(":")[0];
                Long hlsunset = (Long.parseLong(hsunset) + 7) % 24;
                String msunset = des[2].split(":")[1];

                des1.setText(hlsunrise.toString() + ":" + msunrise);
                des2.setText(hlsunset.toString() + ":" + msunset);
                des3.setText(des[3]);
                des4.setText(des[4]);
                des5.setText(des[5]);
                des6.setText(des[6]);
